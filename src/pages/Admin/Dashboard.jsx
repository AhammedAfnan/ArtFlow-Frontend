    ...
    <>
      ...
      <div className="min-h-full">
        ...
        <div className="flex flex-wrap bg-gray-500 ">
          <div className="mt-4 w-full lg:w-6/12 xl:w-4/12 px-5 mb-4">
            <div className="relative flex flex-col min-w-0 break-words bg-white rounded mb-3 xl:mb-0 shadow-lg">
              <div className="flex-auto p-4">
                ...
                <p className="text-sm text-green-600 text-blueGray-400 mt-4">
            ...
            <div className="relative flex flex-col min-w-0 break-words bg-white rounded mb-3 xl:mb-0 shadow-lg">
              <div className="flex-auto p-4">
                ...
                <p className="text-sm text-blueGray-400 mt-4">
                  <span
                    className="whitespace-nowrap text-blue-500 cursor-pointer underline"
          ...
          <div className=" mt-4 w-full lg:w-6/12 xl:w-4/12 px-5">
        ...
        <footer className="bg-black dark:bg-gray-800">
          <div className="ml-0 w-full max-w-full p-4 py-6 lg:py-8">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-yellow-500 sm:text-center dark:text-yellow-500">
                © 2023{" "}
              ...
              <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                <a
                  href="#"
                  className="text-yellow-500 hover:text-yellow-500 dark:hover:text-white"
                >
                  <svg
                    className="w-4 h-4"
                    aria-hidden="true"
                  ...
                  <a
                    href="#"
                    className="text-yellow-500 hover:text-white dark:hover:text-white"
                  ></a>
